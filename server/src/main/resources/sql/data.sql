INSERT INTO chatapp.chat_files (file_name, file_path, file_size, file_type) VALUES
    ...
    ('paracetamol', 'C:\Users\Ivaylo_nikolaev\Desktop\ChatApplication\server\src\main\resources\files\19e3d807-5d14-40f0-9a68-3c97f90364d1.jpg', 55016, 'jpg'),
...
INSERT INTO chatapp.notifications (content, message_type, send_date, file_id, sender_id, group_id) VALUES
    ...
    (NULL, 'FILE', '2022-01-07 14:39:24.989', 1, 5, 6),
    ...
    ('Can you bring me the paracetamol?', 'TEXT', '2022-01-07 14:50:54.606', NULL, 4, 8),
    ('How does it look like?', 'TEXT', '2022-01-07 14:51:54.606', NULL, 14, 8),
    (NULL, 'FILE', '2022-01-07 15:05:14.759', 2, 4, 8),
    ...
    (NULL, 'FILE', '2022-01-07 16:19:54.681', 3, 3, 5),
